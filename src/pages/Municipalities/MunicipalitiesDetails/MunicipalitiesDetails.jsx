...
import { getMunicipality, saveMunicipality } from "../services";
...
const MunicipalitiesDetails = () => {
  const { mid } = useParams();
    ...
    const handleData = async () => {
      try {
        setIsLoading(true);
        let response = await getMunicipality(user.access_token, mid);
    ...
    const saveData = async () => {
      try {
        let response = await saveMunicipality(user.access_token, data);
        handleBack();
    ...
    return(
       <PageWrapper title="Detalji opštine" back={handleBack}>
...
export default MunicipalitiesDetails;