...
class ImportApiService {
   ...
   * @param {{}} map The chosen mapping for columns.
   *
   * @return {Promise<APIResponse>}
   */
  postProductsImportExecute(commit, uuid, offset, map) {
    return this._execute("POST", "admin/products/import/execute", { commit, uuid, offset, map })
  }
