      ...
      <>
        ...
        <Buttons className={"col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4"} styleWrapperButtons={{ alignItems: "center", marginTop: "0.2rem" }}>
          <Button
            ...
            sx={{ display: currentStep === 2 ? "none" : "flex", padding: "9px", width: "100%" }}
            variant="contained"
          />
          {currentStep === 2 &&
            <Button
              ...
              variant="contained"
              sx={{ backgroundColor: "var(--red)", padding: "9px", width: "100%" }}
            />
          }
        </Buttons>
      </>
      {currentStep === 2 && (
        <>
          ...
          <InputText
            ...
            onChange={(e) => { setDescriptionReclamatins(e.target.value) }}
            uiProp={{
              columns: {
                xs: 12,
                sm: 12,
