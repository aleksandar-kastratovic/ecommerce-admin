...
const B2BReclamationsDetails = () => {
  ...
  return <DetailsPage title={data?.id == null ? "Unos nove reklamacije" : data?.slug} fields={fields} ready={[rid === "new" || data?.id]} selectedPanel={activeTab} panelHandleSelect={panelHandleSelect} />;
};
