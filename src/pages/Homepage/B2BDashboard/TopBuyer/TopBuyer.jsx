...
const TopBuyer = ({ cusTopBuyerB2B, cusNeverOrderedPercentageB2B, cusSingleOrderPercentageB2B }) => {
  ...
  return (
    <Card
      ...
      children={
        <>
          <CardHeader
            title={<Typography variant="h6" sx={{ color: "var(--text-color)" }}>Kompanije</Typography>}
          />
          <CardContent>
