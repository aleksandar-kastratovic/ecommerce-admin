import { faFileAlt, faCity, faCog, faUserTag, faSitemap, faArchive, faSearchLocation, faUsers, faPeopleArrows, faImage, faUpload } from "@fortawesome/free-solid-svg-icons"
...
const screens = {
  CATEG: [ "/categories", "Kategorije", faSitemap, PRODUCT, CategoriesPage, [ [ ":catId", CategoriesPage ] ] ],
  PRODU: [ "/products", "Proizvodi", faArchive, PRODUCT, Products, [ [ ":prodId", ProductDetails ] ] ],

  ORDER      : [ "/orders", "Porudžbine", faFileAlt, B2B, OrdersPage, [ [ ":ordId", OrdersPage ] ] ],
  COMPN      : [ "/companies", "Kompanije", faCity, B2B, CompaniesPage, [ [ ":comId", CompaniesPage ] ] ],
  CUSTM      : [ "/b2b-customers", "Kupci", faUserTag, B2B, B2BCustomersPage, [ [ ":cusId", B2BCustomersPage ] ] ],
  BANNERS_B2B: [ "/B2B-banners", "B2B baneri", faImage, B2B, B2Bbanners, [ [ ":B2BId", DetailsBanners ] ] ],
  B2BCFG     : [ "/B2B-settings", "B2B podešavanja", faCog, B2B, B2Bsettings, [ [ ":B2BId", DetailsForm ] ] ],

  BANNERS_B2C: [ "/B2C-banners", "B2C baneri", faCog, B2C, B2Cbanners, [ [ ":B2CId", DetailsBannersB2C ] ] ],
  B2CCFG     : [ "/B2C-settings", "B2C podešavanja", faCog, B2C, B2CSettings, [ [ ":B2CId", B2CSettings ] ] ],
  ...
  ADMIN_FORM: [ "/admin-form", "Admin forme", faCog, SETTINGS, AdminForms, [ [ ":FormId", DetailsAdminForm ] ] ],
