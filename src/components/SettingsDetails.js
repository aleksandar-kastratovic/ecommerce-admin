    ...
    <div className="add-role-modal">
      ...
      <div className="row">
        <div className="col-6">
          <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              <Accordion.Header className="alert-info"><FontAwesomeIcon icon={faCog} />Osnovna podešavanja:</Accordion.Header>
              <Accordion.Body>
                <div className="row">
        ...
        <div className="col-6">
          <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
              <Accordion.Header className="alert-info"><FontAwesomeIcon icon={faIcons} />Logo:</Accordion.Header>
              <Accordion.Body>
                <div className="row">
                  <div className="col-12">
                    <div>
