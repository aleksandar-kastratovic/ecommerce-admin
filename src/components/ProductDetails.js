...
import { faImages, faFileSignature, faMoneyBill, faTimes, faBoxes, faEye, faEyeSlash } from "@fortawesome/free-solid-svg-icons";
...
import { attributesListService, attributeValuesListService, categoryListService } from "../helpers/services";
...
const ProductDetails = ({ saveProduct, productData, addProduct, removeProduct }) => {
    ...
    let { value: additionalNameValue, valueChangeHandler: additionalNameChangeHandler, reset: resetAdditionalName } = useInput((value) => value);

    let { value: descriptionValue, valueChangeHandler: descriptionChangeHandler, reset: resetDescription } = useInput((value) => value);

    let { value: codeValue, valueChangeHandler: codeChangeHandler, reset: resetCode } = useInput((value) => value);

    let { value: unitValue, valueChangeHandler: unitChangeHandler, reset: resetUnit } = useInput((value) => value);

    let { value: skuValue, valueChangeHandler: skuChangeHandler, reset: resetSku } = useInput((value) => value);

    let { value: gtinValue, valueChangeHandler: gtinChangeHandler, reset: resetGTIN } = useInput((value) => value);

    let { value: b2bPriceValue, valueChangeHandler: b2bPriceChangeHandler, reset: resetB2BPrice } = useInput((value) => value);

    let { value: purchasePriceValue, valueChangeHandler: purchasePriceChangeHandler, reset: resetPurchasePrice } = useInput((value) => value);

    let { value: vatValue, valueChangeHandler: vatChangeHandler, reset: resetVAT } = useInput((value) => value);
    ...
    return (
        <div className="add-role-modal">
            <div className="btn-group mb-4" role="group" aria-label="Basic example">
                <button onClick={() => submitHandler()} type="button" className="btn-control btn btn-add-details" disabled={!nameIsValid || categoryIds.length < 1}>
                    <FontAwesomeIcon className="me-1" icon={faSave} />
                    Sačuvajte
                </button>
                <button type="button" className="btn-control btn btn-show-details" onClick={() => setB2BIsVisible(b2bIsVisible === 0 ? 1 : 0)}>
                    {b2bIsVisible === 0 && (
                        <>
                            ...
                            <div className="col-xl-12 details-wrapper">
                                ...
                                <div className="row row-m0">
                                    <div className="col-12 p-0">
                                        <p htmlFor="dropdownTreeSelectCategory" className="m-0 form-control-label required">
                                            Kategorije
                                        </p>
                                        <DropdownTreeSelect
                                            className={
                                ...
                                <Form.Group className="remember-checkbox remember-checkbox-details">
                                    <Form.Check type="checkbox" label="Istaknut proizvod" checked={isPromoted} onChange={() => setIsPromoted(isPromoted ? 0 : 1)} />
                                </Form.Group>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-9 details-wrapper-spacing">
                        <div className="row">
                            <div className="col-xl-12 details-wrapper">
                                ...
                                <hr className="form-fields-separation"></hr>
                                <button className="btn-control save-btn" onClick={() => setSelectedProductAttributes([...selectedProductAttributes, optionInit])}>
                                    Dodajte opciju
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-xl-12 details-wrapper">
                                <div className="products-list-holder">
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="col-xl-1 align-self-center align-self-center">
                                                    {object.images.length > 0 && <img className="img-fluid" src={object.mainImg} alt={object.mainImg} />}

                                                    {object.images.length < 1 && <img className="img-fluid" src={noImage} alt={noImage} />}
                                                </div>
                                                ...
                                                <div className="col-xl-1 align-self-center">
                                                    <button
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                                                            confirm(["Da li ste sigurni?", () => removeVariation(index)]);
                                                        }}
                                    ...
                                    <hr className="form-field-separation"></hr>
                                    <button className="btn-control save-btn" onClick={() => addNewVariation()}>
                                        Dodajte varijaciju
                                    </button>
                                </div>
                            </div>
