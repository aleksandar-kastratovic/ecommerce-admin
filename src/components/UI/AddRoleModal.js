    ...
    return (
        <Modal show={openModal} onHide={handleClose} backdrop="static" keyboard={false} centered size="xl" scrollable={true} className="add-role-modal">
                            ...
                            <div className="row screens-wrapper buyers">
                                ...
                                {referenceData.screens !== undefined &&
                                    referenceData.screens.map(function (object) {
                                        return (
                                            <Form.Group key={object.id} className="remember-checkbox" controlId="formBasicCheckbox5">
            ...
            <Modal.Footer>
                ...
                <button disabled={!nameIsValid || !selectedScreensValid} type="button" className="btn-control save-btn" onClick={submitHandler}>
                    Sačuvajte
                </button>
            </Modal.Footer>
        </Modal>
